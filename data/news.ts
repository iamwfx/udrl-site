...
export const newsItems: NewsItem[] = [
  ...
  },
  {
    ...
    date: "January 2023",
    description:
      "I co-authored a report for King County with ECONorthwest (where I'm an Affiliated Scholar), estimating the wealth impact of redlining, restrictive covenants, and exclusionary zoning on communities of color.",
    details:
      "In January 2023, I co-authored a report for the King County Wastewater Treatment Division, produced with ECONorthwest (where I'm an Affiliated Scholar). The report looks at the historical wealth impact of discriminatory housing practices in King County — HOLC redlining maps, racially restrictive deed covenants, exclusionary zoning — on communities of color. We combined historical records with contemporary wealth and property data to put quantitative estimates on the cumulative wealth losses. It's part of a growing body of work being used to support reparative and restorative housing policy at the local level.",
  },
];
