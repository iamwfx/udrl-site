...
export const people: Person[] = [
  {
    ...
    bio: "Wenfei Xu is an Assistant Professor in GIScience and Urban Data Science in the Department of Geography at UC Santa Barbara, where she directs the Urban Data Research Lab and holds faculty affiliations with the Center for Spatial Studies and Data Science and the Broom Center for Demography. Her research uses novel big data and spatial data science to understand urban inequality at the neighborhood scale in order to inform housing policy and opportunities for more equitable cities. Her work has been published in the <em>Proceedings of the National Academies of Science</em>, <em>Annals of the Association of American Geographers</em>, <em>Urban Studies</em>, <em>Nature Scientific Data</em>, and <em>Housing Policy Debate</em>, and has been funded by the NSF, the Russell Sage Foundation, and the Washington Center for Equitable Growth. Prior to joining UCSB, she was Assistant Professor in the Department of City and Regional Planning at Cornell University (2022–2025) and a Postdoctoral Fellow at the University of Chicago's Mansueto Institute for Urban Innovation and Center for Spatial Data Science (2022). She holds a Ph.D. in Urban Planning from Columbia University, an MCP and M.Arch from MIT, and a B.A. in Economics from the University of Chicago.",
